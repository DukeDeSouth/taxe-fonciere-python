...
VC20      02 TAUDIS-SUITE  PIC X(3988).                                         
      ...
      *----------------------------------------------------------------*        
       ...
       01  VERSION PIC X(23) VALUE 'EFITAUX2 11 DU 02/06/21'.                   
      *   *** ADR/LIBRARIAN SLAT VARIABLES FOLLOW ***                           
       01  SLATVARS              PIC X(122)                 VALUE 'SLAT         
      -    'VARS START:21/06/0211:17:56BEHYVER        EFITAUX20000100001        
      ...
      *--- FILE STATUS DE TAUDIS -----------------                              
       ...
       01 TAUDIS-DIR.                                                           
IH21     COPY  T100      REPLACING 'X' BY T-D.                                  
IH21     COPY  T14D      REPLACING 'X' BY T-D.                                  
                                                                                
       01 TAUDIS-COM.                                                           
IH21     COPY  T100      REPLACING 'X' BY T-C.                                  
IH21     COPY  T14C      REPLACING 'X' BY T-C.                                  
                                                                                
       01 TAUDIS-IFP-TRESO.                                                     
IH21     COPY  T100      REPLACING 'X' BY T-R.                                  
IH21     COPY  T14R      REPLACING 'X' BY T-R.                                  
