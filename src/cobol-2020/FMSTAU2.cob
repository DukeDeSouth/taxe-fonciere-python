*******        OBJET : FMSTAU2   , LANG : COB                                   
*******        CREE SOUS LE WO : WO019128                                       
*******        DATE : 18 JAN 2017     HEURE : 10:42:08                          
      ...
      *               5EM ELEMENT : INFO TSE, TSEGP, EPCI        *              
      *               (fourni sous forme d'un occurs 3 )         *              
      *                             et ADRESSE MEL EPCI          *              
      *               6EM ELEMENT : INFO LIBELLE BENEFICIAIRE OM *              
      *                             et ADRESSE MEL COMMUNE       *              
      *               7EM ELEMENT : INFO LIBELLES SYNDICATS      *              
      *                                                          *              
      *               SI LES 4 PARAMETRES (TETE DIR COM SR)      *              
      *               SONT SERVIS, 4 ELEMENTS  AU MOINS SERONT   *              
      *               REMPLIS (MAXIMUM 7 ELEMENTS)               *              
      ...
      *    24   01     SEGMENT SR SUITE  NON TROUVE              *              
      *    25   01     SEGMENT DIR ORIGINE NON TROUVE (EN CAS DE *              
      ...
      * ANNEE SERVIE - DIR SERVIE  - COM SERVIE - CODE IFP Y SERVI    ***       
       01   XB41.                                                               
       COPY XB41.                                                               
      *-------------    article pour restitution des 3 libelles        ***      
      *------------- 1er  occurs : libelle TSE          sur 100 C.     ***      
      *------------- 2}me occurs : libelle TSE GP,MA,GA sur 100 C.     ***      
      *------------- 3er  occurs : libelle EPCI sur 100 caract}res     ***      
      *-------------             : adresse mel EPCI sur 100 C.         ***      
       01   XB50.                                                               
       COPY XB50.                                                               
      *-------------    article pour restitution des 2 libell{s        ***      
      *------------- 1er  occurs : libell{ TEOM         sur 100 C.     ***      
      *------------- 2}me occurs : libell{ TANB         sur 100 C.     ***      
      *-------------             : adresse mel commune sur 100 C.      ***      
       01   XB51.                                                               
       COPY XB51.                                                               
       LINKAGE SECTION.                                                         
      ...
      *  RECHERCHE DU LIBELLE GROUPEMENT TEOM SI CODE RENSEIGNE                 
                IF (CR NOT > 2 AND XB40-CTYSYN NOT = SPACE                      
                    ...
                    PERFORM RECH-LTEOM                                          
                END-IF                                                          
      *  RECHERCHE DU LIBELLE GROUPEMENT TANB SI CODE RENSEIGNE                 
      ...
      *  RECHERCHE DE L'ARTICLE LIBELLE TEOM DANS LA BASE TAUX                  
       RECH-LTEOM.                                                              
              ...
              IF (DLI-RETOUR NOT = SPACE AND NOT = 'GE')                        
                   MOVE  16  TO  CR    MOVE DLI-RETOUR TO RC                    
              ELSE                                                              
                   MOVE XB38    TO XB51-AENR(1)                                 
              END-IF                                                            
                .                                                               
      *                                                                         
      *  RECHERCHE DE L'ARTICLE LIBELLE TANB DANS LA BASE TAUX                  
       RECH-LTANB.                                                              
              INITIALIZE XB37                                                   
              MOVE FIE01-JANIPT TO W-LIB-AN                                     
              MOVE FIE01-ACODIR TO W-LIB-DIR                                    
