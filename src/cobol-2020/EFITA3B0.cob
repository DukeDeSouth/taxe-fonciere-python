      ...
      * BATIES DE TAXE FONCIERE DE L'ANNEE 2020.              *                 
      *                                                       *                 
      *********************************************************                              
      ...
      *   *** ADR/LIBRARIAN SLAT VARIABLES FOLLOW ***                           
      ...
      -    'VARS START:20/06/0218:31:14BECARET        EFITA3B00000100001        
      -    'GO2.TAX.PGM                                 SLAT VARS END'.         
                                                                                                 
       01  VERSION PIC X(23) VALUE 'EFITA3B0 04 DU 02/06/20'.                   
