      *-----------------------------------------------------------              
      *    NOM EXTERNE                :  T34R                                   
      *    MODIFIE  LE                :  02/11/23 POUR LES RS D'AVRIL 2024      
      *    ARTICLE IFP TRESORERIE DU TAUDIS                                     
      *                                                                         
      *    ANNEE 2023. LONGUEUR T300 + T34R = 4000                              
      *                                                                         
      *-----------------------------------------------------------              
...
3087             15 'X'-MLBSYJ PIC S9(9) SIGN LEADING SEPARATE.                 
      ...
      ********************************************                              
      *                                          *                              
      *  NOMBRE DE LISSAGES POUR REI             *                              
      *                                          *                              
      ********************************************                              
               10 'X'-NB-LISSAGES-REI.                                          
      * NOMBRE DE LISSAGES COMMUNE                                              
3097             15 'X'-FILLER PIC X.                                           
3098             15 'X'-NB-LISS-COM PIC 9(7).                                   
      * NOMBRE DE LISSAGES SYNDICAT                                             
3105             15 'X'-FILLER PIC X.                                           
3106             15 'X'-NB-LISS-SYN PIC 9(7).                                   
      * NOMBRE DE LISSAGES INTER-CO                                             
3113             15 'X'-FILLER PIC X.                                           
3114             15 'X'-NB-LISS-CU PIC 9(7).                                    
      * NOMBRE DE LISSAGES TSE 1                                                
3121             15 'X'-FILLER PIC X.                                           
3122             15 'X'-NB-LISS-TSE1 PIC 9(7).                                  
      * NOMBRE DE LISSAGES TSE 2                                                
3129             15 'X'-FILLER PIC X.                                           
3130             15 'X'-NB-LISS-TSE2 PIC 9(7).                                  
      * NOMBRE DE LISSAGES TASA                                                 
3137             15 'X'-FILLER PIC X.                                           
3138             15 'X'-NB-LISS-TASA PIC 9(7).                                  
      * NOMBRE DE LISSAGES GEMAPI                                               
3145             15 'X'-FILLER PIC X.                                           
3146             15 'X'-NB-LISS-GEMAPI PIC 9(7).                                
      * NOMBRE DE LISSAGES OM                                                   
3153             15 'X'-FILLER PIC X.                                           
3154             15 'X'-NB-LISS-OM PIC 9(7).                                    
                                                                                
      ********************************************                              
      *                                          *                              
      *  ZONES SPECIFIQUES POUR ROLE REGULE      *                              
      *       REMPLACEES PAR UN FILLER           *                              
      *                                          *                              
      ********************************************                              
3161           10 'X'-FILLER        PIC X(363).                                 
      ...
      * BRAV DGE                                                                
3524             15 'X'-FILLER PIC X.                                           
                 15 'X'-AGEREF.                                                 
3525               20 'X'-DCPNU1 PIC 9(7).                                      
3532               20 'X'-KCPCLE PIC X(2).                                      
      * BRAV NON DGE                                                            
3534             15 'X'-FILLER PIC X.                                           
                 15 'X'-REF-ARTCOLL.                                            
3535               20 'X'-DCPNU9 PIC 9(7).                                      
3542               20 'X'-KNOCP  PIC X(2).                                      
      ...
      *                                          *                              
      ********************************************                              
3544           10 'X'-FILLER            PIC X(1).                               
3545           10 'X'-TOP-AFFICH-REC    PIC X(1).                               
3546           10 'X'-FILLER            PIC X(1).                               
3547           10 'X'-DLICOM-REC        PIC X(30).                              
3577           10 'X'-FILLER            PIC X(1).                               
3578           10 'X'-CCOCOM-REC        PIC X(3).                               
3581           10 'X'-FILLER            PIC X(1).                               
3582           10 'X'-SIRENC-REC        PIC X(9).                               
                                                                                
      ********************************************                              
      * LIBELLE DE LA PERCEPTION                *                               
      ********************************************                              
3591           10 'X'-FILLER        PIC X(1).                                   
3592           10 'X'-DLIPER        PIC X(30).                                  
3622           10 'X'-FILLER        PIC X(1).                                   
3623           10 'X'-CODIQUE-TRESO PIC X(7).                                   
3630           10 'X'-FILLER        PIC X(1).                                   
3631           10 'X'-NUA-ASSIETTE  PIC X(10).                                  
3641           10 'X'-FILLER        PIC X(1).                                   
3642           10 'X'-NUA-REC       PIC X(10).                                  
                                                                                
      ********************************************                              
      * INDICATEUR MODIFICATION                 *                               
      ********************************************                              
3652           10 'X'-MODIF-IFP   PIC X.                                        
                                                                                
3653           10 'X'-FILLER      PIC X(348).                                   
