      ...
      * NON BATIS DE TAXE FONCIERE DE L'ANNEE 2023.           *                 
      *                                                       *                 
      *********************************************************                 
      * MAINTENANCE 2023                                      *                 
      * - MAJ DU MILLESIME DE L'ANN{E 2023                    *                 
      * - MAJ DE LA VERSION (EFITA3N3)                                          
      * - MAJ DU NOM DU PROGRAM-ID : EFITA3N2 -> EFITA3N3     *                 
      *********************************************************                 
      * PROGRAMME EFITA3N2                                    *                 
      * LANGAGE COBOL                                         *                 
      * NON BATIS DE TAXE FONCIERE DE L'ANNEE 2022.           *                 
      *********************************************************                 
      * MAINTENANCE 2021                                                        
      * - MAJ DU MILLESIME DE L'ANN{E 2021                                      
      * - MAJ DE LA VERSION (DATE)                                              
      * - MAJ DU NOM DU PROGRAM-ID : EFITA3N0 -> EFITA3N1                       
      *********************************************************                 
      ...
      *   *** ADR/LIBRARIAN SLAT VARIABLES FOLLOW ***                           
      ...
      -    'VARS START:23/03/1514:12:47BEHYVER        EFITA3N30000100001        
      -    'GO2.TAX.PGM                                 SLAT VARS END'.         
                                                                                
       01  VERSION PIC X(23) VALUE 'EFITA3N3 21 DU 15/03/23'.                   
      *                                                                         
      ...
      * SUR LES DIFFERENTES APPLICATIONS APPELLANT CE SOUS PRG    *             
      *                                                           *             
      *************************************************************             
      ...
      * DANS CERTAINS CAS LES FRAIS D'ASSIETTE SONT INF{RIEURS                  
      * DE 1 EURO AUX FRAIS DE DEGREVEMENT ET DE NON VALEUR                     
      * DANS CE CAS, ON REEQUILIBRE ARTIFICIELLEMENT AFIN QUE                   
      * FRAIS ASSIETTE > FRAIS DNV                                              
           IF COTISNB-FARC(1) < COTISNB-FRNVC(1)                                
             ADD      1 TO COTISNB-FARC(1)                                      
             SUBTRACT 1 FROM COTISNB-FRNVC(1)                                   
           END-IF                                                               
