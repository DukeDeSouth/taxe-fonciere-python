      ...
      *----------------------------------------------------------------*        
       ...
       01 TAUDIS-DATA .                                                         
          02 TAUDIS-CLE.                                                        
             ...
             05 T-CCOIFP PIC X(3).                                              
             05 T-CCPPER PIC X(3).                                              
          02 TAUDIS-SUITE  PIC X(3988).                                         
                                                                                
      *----------------------------------------------------------------*        
       WORKING-STORAGE SECTION.                                                 
       01  VERSION PIC X(23) VALUE 'EFITAUX2 18 DU 15/03/23'.                   
      *   *** ADR/LIBRARIAN SLAT VARIABLES FOLLOW ***                           
       01  SLATVARS              PIC X(122)                 VALUE 'SLAT         
      -    'VARS START:23/03/1513:59:59BEHYVER        EFITAUX20000100001        
      ...
      *--- FILE STATUS DE TAUDIS -----------------                              
       ...
       01 TAUDIS-DIR.                                                           
         COPY  T300      REPLACING 'X' BY T-D.                                  
         COPY  T34D      REPLACING 'X' BY T-D.                                  
                                                                                
       01 TAUDIS-COM.                                                           
         COPY  T300      REPLACING 'X' BY T-C.                                  
         COPY  T34C      REPLACING 'X' BY T-C.                                  
                                                                                
       01 TAUDIS-IFP-TRESO.                                                     
         COPY  T300      REPLACING 'X' BY T-R.                                  
         COPY  T34R      REPLACING 'X' BY T-R.                                  
      ...
      *       TAUX REDUIT                                                       
                MOVE T-R-TOTOFR         TO TAU-R-TOTOFR                         
      *       TAUX COMMUNAL BATI                                                
