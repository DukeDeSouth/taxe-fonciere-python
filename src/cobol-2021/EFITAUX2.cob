      ...
      *--- FILE STATUS DE TAUDIS -----------------                              
       ...
       01 TAUDIS-DIR.                                                           
         COPY  T100      REPLACING 'X' BY T-D.                                  
         COPY  T14D      REPLACING 'X' BY T-D.                                  
                                                                                
       01 TAUDIS-COM.                                                           
         COPY  T100      REPLACING 'X' BY T-C.                                  
         COPY  T14C      REPLACING 'X' BY T-C.                                  
                                                                                
       01 TAUDIS-IFP-TRESO.                                                     
         COPY  T100      REPLACING 'X' BY T-R.                                  
         COPY  T14R      REPLACING 'X' BY T-R.                                  
