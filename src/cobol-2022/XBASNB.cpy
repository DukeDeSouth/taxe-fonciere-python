      ...
      **  AUTEUR             : CARRO                       **                   
      **==================================================***                   
      **  DATE DERNIERE MAJ  : 03/03/2015                  **                   
      **  AUTEUR             : BESSARD                     **                   
      *******************************************************                   
      **  DATE DERNIERE MAJ  : 04/05/2010                  **                   
      **  AUTEUR             : COLOMBET                    **                   
      *******************************************************                   
EC10  *  MISE EN PLACE TX CHB AGR ST MARTIN                 *                   
EC10  *  AUGMENTATION DE 240 CAR                             *                  
      *******************************************************                   
DC08  *  MISE EN PLACE DES TX AMALGAME TSEN     05.03.2008  *                   
DC08  *  AUGMENTATION DE 20 CAR                             *                   
      *******************************************************                   
      *   06/03/96  :  AJOUT 3 BASES DEGREV JA ETAT         *                   
      *******************************************************                   
           05  'X'-CLE.                                                         
...
JMB15          10 'X'-TAUGEM                      PIC S9(4)V9(6).               
               10 'X'-TAUTSE                      PIC S9(4)V9(6).               
DT06           10 'X'-TAUTSEN            PIC S9(4)V9(6) OCCURS 2.               
               10 'X'-TAUCHAGR                    PIC S9(4)V9(6).               
EC10           10 'X'-TAUSMAGR                    PIC S9(4)V9(6).               
               10 'X'-TAUBAPSA                    PIC S9(4)V9(6).               
               10 'X'-TAUCAAA                     PIC S9(4)V9(6).               
BP11           10 'X'-TAUTXADD                    PIC S9(4)V9(6).               
DC08       05 'X'-PNBTST                      PIC S9(4)V9(6).                   
BP11       05 'X'-FILLER4                     PIC X(235).                       
      ****************************************                                  
...
JMB15      05 'X'-REDGEM  REDEFINES 'X'-BNBGEM.                                 
JMB15        10 'X'-GEMFRS                     PIC 9(007).                      
JMB15        10 'X'-GEMCTS                     PIC S9(003).                     
           05 'X'-BNBTSE                      PIC S9(010).                      
           05 'X'-REDTSE  REDEFINES 'X'-BNBTSE.                                 
             10 'X'-TSEFRS                    PIC 9(007).                       
             10 'X'-TSECTS                    PIC S9(003).                      
DT06       05 'X'-TAB-BNBTSEN OCCURS 2.                                         
DT06         10 'X'-BNBTSEN                   PIC S9(010).                      
DT06         10 'X'-REDTSEN REDEFINES 'X'-BNBTSEN.                              
DT06           20 'X'-TSENFRS                   PIC 9(007).                     
DT06           20 'X'-TSENCTS                   PIC S9(003).                    
