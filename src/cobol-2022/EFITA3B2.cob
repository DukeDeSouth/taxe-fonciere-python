      *********************************************************                 
JMB22 * PROGRAMME EFITA3B2                                    *                 
      * MAINTENANCE 2022                                                        
IH22  * - MAJ DU MILLESIME DE L'ANN{E 2022                    *                 
      *********************************************************                 
IH21  * PROGRAMME EFITA3B1                                    *                 
      * LANGAGE COBOL                                         *                 
      *                                                       *                 
      * CE SOUS-PROGRAMME EST LA CALCULETTE DES COTISATIONS   *                 
IH21  * BATIES DE TAXE FONCIERE DE L'ANNEE 2021.              *                 
      *                                                       *                 
      *********************************************************                 
IH21  * MAINTENANCE 2021                                                        
      * - MAJ DU MILLESIME DE L'ANN{E 2021                                      
      * - MAJ DE LA VERSION (DATE)                                              
      * - MAJ DU NOM DU PROGRAM-ID : EFITA3B0 -> EFITA3B1                       
      * - SUPPRESSION DU DEPARTEMENT                                            
      *********************************************************                 
VC20  * MAINTENANCE 2020                                                        
      * - MAJ DU MILLESIME DE L'ANN{E 2020                                      
      * - MAJ DE LA VERSION (DATE)                                              
      * - MAJ DU NOM DU PROGRAM-ID : EFITA3B9 -> EFITA3B0                       
      *********************************************************                 
VB19  * MAINTENANCE 2019                                                        
      * - MAJ DU MILLESIME DE L'ANN{E 2019                                      
      * - MAJ DE LA VERSION (DATE)                                              
      * - MAJ DU NOM DU PROGRAM-ID : EFITA3B8 -> EFITA3B9                       
      * - FRAIS GESTION TEOM A 3% POUR LES 5 PREMIERES ANNEES                   
      *********************************************************                 
                                                                                
       ID DIVISION.                                                             
JMB22  PROGRAM-ID. EFITA3B2.                                                    
       DATA DIVISION.                                                           
       WORKING-STORAGE SECTION.                                                 
      *   *** ADR/LIBRARIAN SLAT VARIABLES FOLLOW ***                           
       01 SLATVARS              PIC X(122)                  VALUE 'SLAT         
      -    'VARS START:22/06/1618:01:13TSOCQF3        EFITA3B20000100001        
      -    'GO2.TAX.PGM                                 SLAT VARS END'.         
                                                                                
       01  VERSION PIC X(23) VALUE 'EFITA3B2 21 DU 16/06/22'.                   
...
VB19   01 W-TOTCOTOM3           PIC S9(11) GLOBAL.                              
VB19   01 W-TOTCOTOM8           PIC S9(11) GLOBAL.                              
...
IH21  *       COMBAT-MBADEP     NOT NUMERIC OR                                  
IH21  *       COMBAT-MBAREG     NOT NUMERIC OR                                  
      ...
      * TAUX COMMUNAL                                                           
              MOVE TAU-R-TAUCOM-B     TO BASEB-TAUCOM                           
                                         COTISB-TAUCOM                          
      * TAUX DEPARTEMENTAL                                                      
IH21  *       MOVE TAU-D-TAUDEP-B     TO BASEB-TAUDEP                           
IH21  *                                  COTISB-TAUDEP                          
      * TAUX TASA                                                               
      ...
      * BASE COMMUNALE                                                          
              MOVE COMBAT-MBACOM      TO BASEB-BBCOM                            
                                         COTISB-BBCOM                           
      * BASE DEPARTEMENTALE                                                     
IH21  *       MOVE COMBAT-MBADEP      TO BASEB-BBDEP                            
IH21  *                                  COTISB-BBDEP                           
...
IH21  *       COMPUTE COTISB-COTIDEP     ROUNDED =                              
IH21  *               COTISB-BBDEP * COTISB-TAUDEP / 100                        
      ...
      *  LES FRAIS DE GESTION DE LA TEOM SONT A TAUX REDUIT DE 3%               
      *  LES 5 PREMIERES ANNEES D'INSTAURATION DE LA TEOMI.                     
              MOVE 0 TO W-TOTCOTOM3                                             
              MOVE 0 TO W-TOTCOTOM8                                             
              PERFORM VARYING IND FROM 1 BY 1 UNTIL IND > 7                     
                IF TAU-R-TOTOFR = 'O'                                           
                 ADD COTISB-COTIS-OM(IND) TO W-TOTCOTOM3                        
                ELSE                                                            
                 ADD COTISB-COTIS-OM(IND) TO W-TOTCOTOM8                        
                END-IF                                                          
              END-PERFORM                                                       
              IF TAU-R-TOTOFR = 'O'                                             
               ADD COTISB-COTIS-OMI     TO W-TOTCOTOM3                          
              ELSE                                                              
               ADD COTISB-COTIS-OMI     TO W-TOTCOTOM8                          
              END-IF                                                            
      * TOTAL DES COTISATIONS SOUMISES AUX FRAIS DE 3%                          
IH21          COMPUTE W-TOTCOT3 = COTISB-COTICOM + COTISB-COTICU +              
IH21                              COTISB-MCOGE3 + W-TOTCOTOM3                   
IH21  *       COMPUTE W-TOTCOT3 = COTISB-COTICOM + COTISB-COTIDEP +             
IH21  *                           COTISB-COTICU + COTISB-MCOGE3 +               
IH21  *                           W-TOTCOTOM3                                   
      * TOTAL DES COTISATIONS SOUMISES AUX FRAIS DE 8%                          
              COMPUTE W-TOTCOT8 = W-TOTCOTOM8 + COTISB-COTISYN +                
                                  COTISB-MCOTA3                                 
      ...
      * DEPARTEMENT                                                             
IH21  *       MOVE COTISB-COTIDEP     TO RETOURB-MCTDEP                         
      * SYNDICAT DE COMMUNE                                                     
      ...
      * TRAITEMENT IMPACT DES FRAIS DE GESTION DE LA TEOM A TAUX                
      * REDUIT DE 3% POUR LES 5 PREMIERES ANNEES D'INTAURATION TEOMI            
               IF TAU-R-TOTOFR = 'O'                                            
                 MOVE W-TOTCOTOM3          TO RETOURB-TCTOM                     
               ELSE                                                             
                 MOVE W-TOTCOTOM8          TO RETOURB-TCTOM                     
               END-IF                                                           
