      *-----------------------------------------------------------              
      *    NOM EXTERNE                :  T24R                                   
      *    MODIFIE  LE                :  10/02/22 POUR LE D4 2022               
      *    ARTICLE IFP TRESORERIE DU TAUDIS                                     
      *                                                                         
      *    ANNEE 2022. LONGUEUR T200 + T24R = 4000                              
      *                                                                         
      *-----------------------------------------------------------              
...
3481           10 'X'-DLICOM-REC  PIC X(30).                                    
3511           10 'X'-FILLER      PIC X(1).                                     
3512           10 'X'-CCOCOM-REC  PIC X(3).                                     
3515           10 'X'-FILLER      PIC X(1).                                     
3516           10 'X'-SIRENC-REC  PIC X(9).                                     
