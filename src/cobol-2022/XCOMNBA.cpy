      ...
      * CODE DEPARTEMENT                                                        
                 20 'X'-CCODIR PICTURE X.                                       
      * CODE DIRECTION                                                          
              15 'X'-CCOCOM PICTURE X(3).                                       
      * CODE COMMUNE MAJIC2                                                     
              15 'X'-DSRPAR PICTURE X.                                          
      * SERIE ROLE PARCELLE                                                     
           10 'X'-ANUPRO.                                                       
      * NUM COMPTE PROPRIETAIRE                                                 
              15 'X'-CGROUP PICTURE X.                                          
      * CODE GROUPE PROPRIETAIRE                                                
              15 'X'-NNUPRO PICTURE 9(5).                                       
      * NUM COMPTE PROPRIETAIRE                                                 
           10 'X'-A0011.                                                        
      * GROUPE 11C                                                              
              15 'X'-GTOTAU PICTURE X OCCURS 11.                                
      ...
      * BASE TSE                                                                
              15 'X'-MBNT13 PICTURE S9(10) OCCURS 2.                            
      ...
      * BASE JEUNE AGRICULTEUR - TSE                                            
              15 'X'-MBJT13 PICTURE S9(10) OCCURS 2.                            
