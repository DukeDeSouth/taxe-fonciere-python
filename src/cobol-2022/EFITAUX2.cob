...
JMB22 * MAINTENANCE 2022                                                        
      *  MAJ DU MILLESIME DU TAUDIS (T2)                                        
      *********************************************************                 
IH21  * MAINTENANCE 2021                                                        
      *  MAJ DU MILLESIME DU TAUDIS (T1)                                        
      *********************************************************                 
VC20  * MAINTENANCE 2020                                                        
      *  MAJ DU MILLESIME DU TAUDIS (T0 / LG : 3500 -> 4000)                    
      *********************************************************                 
VB19  * MAINTENANCE 2019                                                        
      *  MAJ DU MILLESIME DU TAUDIS (T9 / LG : 3000 -> 3500)                    
      *  MOVE DE TOTOFR                                                         
      *********************************************************                 
      ...
      *----------------------------------------------------------------*        
       FILE SECTION.                                                            
       FD  TAUDIS EXTERNAL                                                      
VC20       RECORD  CONTAINS 4000 CHARACTERS                                     
       ...
       01 TAUDIS-DATA .                                                         
          02 TAUDIS-CLE.                                                        
             ...
             05 T-CCOIFP PIC X(3).                                              
             05 T-CCPPER PIC X(3).                                              
VC20      02 TAUDIS-SUITE  PIC X(3988).                                         
                                                                                
      *----------------------------------------------------------------*        
       WORKING-STORAGE SECTION.                                                 
       01  VERSION PIC X(23) VALUE 'EFITAUX2 17 DU 16/06/22'.                   
      *   *** ADR/LIBRARIAN SLAT VARIABLES FOLLOW ***                           
       01  SLATVARS              PIC X(122)                 VALUE 'SLAT         
      -    'VARS START:22/06/1618:01:10TSOCQF3        EFITAUX20000100001        
      ...
      *--- FILE STATUS DE TAUDIS -----------------                              
       ...
       01 TAUDIS-DIR.                                                           
JMB22    COPY  T200      REPLACING 'X' BY T-D.                                  
JMB22    COPY  T24D      REPLACING 'X' BY T-D.                                  
                                                                                
       01 TAUDIS-COM.                                                           
JMB22    COPY  T200      REPLACING 'X' BY T-C.                                  
JMB22    COPY  T24C      REPLACING 'X' BY T-C.                                  
                                                                                
       01 TAUDIS-IFP-TRESO.                                                     
JMB22    COPY  T200      REPLACING 'X' BY T-R.                                  
JMB22    COPY  T24R      REPLACING 'X' BY T-R.                                  
...
VB19  *       TAUX REDUIT                                                       
VB19            MOVE T-R-TOTOFR         TO TAU-R-TOTOFR                         
      *       TAUX COMMUNAL BATI                                                
...
DS19  *       DELIB EPCI DEGVT JA N-4 ANNEE INSTALLATION                        
I               MOVE T-R-JGCIN5         TO TAU-C-JGCINS(1)                      
I     *       DELIB EPCI DEGVT JA N-4 ANNEE RETOUR IMPOSITION                   
I               MOVE T-R-JGCRI5         TO TAU-C-JGCRIM(1)                      
I     *       DELIB EPCI DEGVT JA N-3 ANNEE INSTALLATION                        
I               MOVE T-R-JGCIN4         TO TAU-C-JGCINS(2)                      
I     *       DELIB EPCI DEGVT JA N-3 ANNEE RETOUR IMPOSITION                   
I               MOVE T-R-JGCRI4         TO TAU-C-JGCRIM(2)                      
I     *       DELIB EPCI DEGVT JA N-2 ANNEE INSTALLATION                        
DS19            MOVE T-R-JGCIN3         TO TAU-C-JGCINS(3)                      
I     *       DELIB EPCI DEGVT JA N-2 ANNEE RETOUR IMPOSITION                   
I               MOVE T-R-JGCRI3         TO TAU-C-JGCRIM(3)                      
I     *       DELIB EPCI DEGVT JA N-1 ANNEE INSTALLATION                        
I               MOVE T-R-JGCIN2         TO TAU-C-JGCINS(4)                      
I     *       DELIB EPCI DEGVT JA N-1 ANNEE RETOUR IMPOSITION                   
I               MOVE T-R-JGCRI2         TO TAU-C-JGCRIM(4)                      
I     *       DELIB EPCI DEGVT JA N   ANNEE INSTALLATION                        
I               MOVE T-R-JGCIN1         TO TAU-C-JGCINS(5)                      
I     *       DELIB EPCI DEGVT JA N   ANNEE RETOUR IMPOSITION                   
DS19            MOVE T-R-JGCRI1         TO TAU-C-JGCRIM(5)                      
