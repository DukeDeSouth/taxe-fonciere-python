      ...
      **  NOM DU COPY        : XCOTNB                      **                   
      **  LONGUEUR           : 600 --> 800                 **                   
      **  DATE CREATION      : 01/09/94                    **                   
      **  AUTEUR             : CARRO                       **                   
      **==================================================***                   
DS17  **  DATE DERNIERE MAJ  : 08/03/2017                  **                   
      **  AUTEUR             : D.SOUMET                    **                   
      *******************************************************                   
JMB15 **  DATE DERNIERE MAJ  : 03/03/2015                  **                   
      **  AUTEUR             : BESSARD                     **                   
      *******************************************************                   
BP12  **  DATE DERNIERE MAJ  : 28/03/2012                  **                   
 -    **  AUTEUR             : PAQUIN                      **                   
      *******************************************************                   
BP11  **  DATE DERNIERE MAJ  : 22/03/2011                  **                   
 -    **  AUTEUR             : PAQUIN                      **                   
      *******************************************************                   
BP11  * AJOUT FRAIS CHAMBRE D AGRICULTURE                   *                   
      *******************************************************                   
EC10  * AJOUT TAUX CHB AGR ST MARTIN                        *                   
EC10  * AGRANDISSMENT DE 240 CAR                            *                   
      *******************************************************                   
DC08  * MISE EN PLACE DES TX AMALGAME TSEN NB    05.03.2008 *                   
DC08  * MISE EN PLACE DES COTIS AMALGAME TSEN NB 05.03.2008 *                   
DC08  * AGRANDISSMENT DE 20 CAR                             *                   
      *******************************************************                   
      *   06/03/96  :  AJOUT BASES COTIS          JA ETAT   *                   
      *******************************************************                   
           05  'X'-CLE.                                                         
...
JMB15      05 'X'-TAUGEM                      PIC S9(4)V9(6).                   
           05 'X'-TAUTSE                      PIC S9(4)V9(6).                   
DT06       05 'X'-TAUTSEN                     PIC S9(4)V9(6) OCCURS 2.          
DC08       05 'X'-PNBTST                      PIC S9(4)V9(6).                   
           05 'X'-TAUCHAGR                    PIC S9(4)V9(6).                   
EC10       05 'X'-TAUSMAGR                    PIC S9(4)V9(6).                   
...
JMB15      05 'X'-BNBGEM                      PIC S9(010).                      
           05 'X'-BNBTSE                      PIC S9(010).                      
DT06       05 'X'-BNBTSEN                     PIC S9(010) OCCURS 2.             
           05 'X'-BNBAGR                      PIC S9(010).                      
           05 'X'-BNBBAP                      PIC S9(010).                      
           05 'X'-BNBCAA                      PIC S9(010).                      
DT06       05 'X'-FILLER6                     PIC X(010).                       
      ****************************************                                  
      ***---- BASE DEG PRE + JA          --***                                  
...
JMB15      05 'X'-MCOGE3                      PIC S9(010).                      
           05 'X'-COTITSE                     PIC S9(010).                      
DT06       05 'X'-COTITSEN                    PIC S9(010) OCCURS 2.             
DC08       05 'X'-MCNTSA                      PIC S9(010).                      
           05 'X'-COTIAGR                     PIC S9(010).                      
EC10       05 'X'-COTISMAG                    PIC S9(010).                      
...
BP12       05 'X'-FA300                       PIC S9(10).                       
BP12       05 'X'-FN300                       PIC S9(10).                       
           05 'X'-FARB                        PIC S9(10).                       
           05 'X'-FRNVB                       PIC S9(10).                       
           05 'X'-FARC                        PIC S9(10).                       
           05 'X'-FRNVC                       PIC S9(10).                       
BP12       05 'X'-FA800                       PIC S9(10).                       
BP12       05 'X'-FN800                       PIC S9(10).                       
BP12       05 'X'-FA900                       PIC S9(10).                       
BP12       05 'X'-FN900                       PIC S9(10).                       
      ****************************************                                  
...
DS17  ***---- IFP   +   TRESORERIE       --***                                  
DS17  ****************************************                                  
DS17       05 'X'-CCOIFP                      PIC X(003).                       
DS17       05 'X'-CCPPER                      PIC X(003).                       
      *                                                                         
DS17       05 'X'-FILLER                      PIC X(306).                       
