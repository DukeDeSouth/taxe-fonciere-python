      *********************************************************                 
JMB22 * PROGRAMME EFITA3N2                                    *                 
      * LANGAGE COBOL                                         *                 
      * NON BATIS DE TAXE FONCIERE DE L'ANNEE 2022.           *                 
      *********************************************************                 
JJ21  * PROGRAMME EFITA3N1                                    *                 
      * LANGAGE COBOL                                         *                 
      *                                                       *                 
      * CE SOUS-PROGRAMME EST LA CALCULETTE DES COTISATIONS   *                 
JJ21  * NON BATIS DE TAXE FONCIERE DE L'ANNEE 2021.           *                 
      *                                                       *                 
      *********************************************************                 
JJ21  * MAINTENANCE 2021                                                        
      ...
      *********************************************************                 
       ...
       ID DIVISION.                                                             
JMB22  PROGRAM-ID. EFITA3N2.                                                    
       DATA DIVISION.                                                           
       WORKING-STORAGE SECTION.                                                 
      *   *** ADR/LIBRARIAN SLAT VARIABLES FOLLOW ***                           
       01  SLATVARS              PIC X(122)                 VALUE 'SLAT         
      -    'VARS START:22/06/1618:01:15TSOCQF3        EFITA3N20000100001        
      -    'GO2.TAX.PGM                                 SLAT VARS END'.         
                                                                                
       01  VERSION PIC X(23) VALUE 'EFITA3N2 19 DU 16/06/22'.                   
      *                                                                         
